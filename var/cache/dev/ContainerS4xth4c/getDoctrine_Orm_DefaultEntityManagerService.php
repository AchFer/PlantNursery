...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, array(0 => ($this->targetDirs[3].'\\src\\AppBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Ecommerce\\EcommerceBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\MainBundle\\Entity'), 4 => ($this->targetDirs[3].'\\src\\PlantBundle\\Entity'), 5 => ($this->targetDirs[3].'\\src\\BlogBundle\\Entity'), 6 => ($this->targetDirs[3].'\\src\\NuseryBundle\\Entity'), 7 => ($this->targetDirs[3].'\\src\\EventBundle\\Entity')));

$b->addDriver($c, 'AppBundle\\Entity');
$b->addDriver($c, 'Ecommerce\\EcommerceBundle\\Entity');
$b->addDriver($c, 'Utilisateur\\UtilisateurBundle\\Entity');
$b->addDriver($c, 'MainBundle\\Entity');
$b->addDriver($c, 'PlantBundle\\Entity');
$b->addDriver($c, 'BlogBundle\\Entity');
$b->addDriver($c, 'NuseryBundle\\Entity');
...
$a->setEntityNamespaces(array('AppBundle' => 'AppBundle\\Entity', 'EcommerceEcommerceBundle' => 'Ecommerce\\EcommerceBundle\\Entity', 'UtilisateurUtilisateurBundle' => 'Utilisateur\\UtilisateurBundle\\Entity', 'MainBundle' => 'MainBundle\\Entity', 'PlantBundle' => 'PlantBundle\\Entity', 'BlogBundle' => 'BlogBundle\\Entity', 'NuseryBundle' => 'NuseryBundle\\Entity', 'EventBundle' => 'EventBundle\\Entity'));
