...
class User extends \MainBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'MainBundle\\Entity\\User' . "\0" . 'firstName', '' . "\0" . 'MainBundle\\Entity\\User' . "\0" . 'lastName', '' . "\0" . 'MainBundle\\Entity\\User' . "\0" . 'number', '' . "\0" . 'MainBundle\\Entity\\User' . "\0" . 'bio', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
