...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, array(0 => ($this->targetDirs[3].'\\src\\Ecommerce\\EcommerceBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle\\Entity')));
...
$a->setEntityNamespaces(array('EcommerceEcommerceBundle' => 'Ecommerce\\EcommerceBundle\\Entity', 'UtilisateurUtilisateurBundle' => 'Utilisateur\\UtilisateurBundle\\Entity'));
