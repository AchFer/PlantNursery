...
class Commande extends \Ecommerce\EcommerceBundle\Entity\Commande implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Commande' . "\0" . 'id', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Commande' . "\0" . 'users', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Commande' . "\0" . 'produits', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Commande' . "\0" . 'valider', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Commande' . "\0" . 'date', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Commande' . "\0" . 'reference'];
        }
